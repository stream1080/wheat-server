...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wheat?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.example.wheat");  //设置包名
        ...
        strategy.setInclude("order_info","order_item","pay_info");  //生成的表，可接多个参数
